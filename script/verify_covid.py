...
def get_args():
    ...
    parser.add_argument("--rationale_model", type=str, default="model/rationale_roberta_large_scifact",
                        help="path to rationale selection model")
    parser.add_argument("--tf", type=bool, default=False,
                        help="Whether or not this is a tensorflow model.")
